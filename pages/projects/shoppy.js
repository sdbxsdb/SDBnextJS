  ...
  return ( 
    <div className="absolute top-[112px] w-full left-0">
      ...
      <MoreInfoCard
        ...
        <a className="underline transition hover:text-blue-400" href="https://github.com/sdbxsdb/react-ts-shop" target="_blank" rel="noreferrer">GitHub</a>
        <a className="underline transition hover:text-blue-400" href="https://react-ts-shop.vercel.app" target="_blank" rel="noreferrer">Live Site</a>
      </div>

      <div className="flex flex-col items-center mb-4">
        <p className='text-smallerTitle'>Faux shop built with React &amp; Typescript</p>
      ...
      <div className="iframeWrapper dark:bg-darkGrey bg-lightGrey">
        <iframe className="w-screen h-[calc(100vh-280px)]" src="https://react-ts-shop.vercel.app"></iframe>
      </div>
