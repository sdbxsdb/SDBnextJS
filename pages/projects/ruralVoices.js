  ...
  return ( 
    <div className="absolute top-[112px] w-full left-0">
      ...
      <MoreInfoCard
        ...
        <a className="underline hover:text-blue-400 transition" href="https://ruralvoices.reflex-dev.com/" target="_blank">Live Site</a>
      </div>

      <div className="">
        <iframe className="w-screen h-[calc(100vh-280px)]" src="https://ruralvoices.reflex-dev.com/"></iframe>
      </div>
