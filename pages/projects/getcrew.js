      ...
      <div className="absolute top-[112px] w-full left-0">
        <div className="flex w-full justify-center items-center gap-x-12 h-[80px]">
          ...
          <div>
            ...
            <br/>
            <br/>
            The app allows registered the user to:
            <br/>
            <br/>
            ...
            <br/>
            <ul class="listElements themeColorText flex flex-col gap-y-2">
            <li>Search for crew via department</li>
            <li>Filter their search via specific job titles</li>
            <li>View each persons profile</li>
            <li>Contact the person via phone or email</li>
            <li>The ability to share a profile</li>
            <li>Download the CV on file for that person</li>
            </ul>
          ...
          <a
            ...
            href="https://github.com/sdbxsdb/we-are-crew"
            target="_blank"
            rel="noreferrer"
          >
            GitHub
        ...
        <div className="flex flex-col items-center mb-4">
          <p className="text-smallerTitle">
            Get Crew - A user login and payment platform
          </p>
          <small>
