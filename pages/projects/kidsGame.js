...
const kidsGame = () => {
  return (
    <>
      <Head>
        <title>Kids Game | Sam Donaghy-Bell</title>
        <meta name="keywords" content="Kids Game" />
        <meta
          name="description"
          content="An interactive drag and drop kids game."
        />
      </Head>
      <div className="absolute top-[112px] w-full left-0">
        <div className="flex w-full justify-center items-center gap-x-12 h-[80px]">
          ...
          <a
            ...
            href="https://github.com/sdbxsdb/Kids-Game"
            target="_blank"
            rel="noreferrer"
          >
            GitHub
          ...
          <a
            className="underline hover:text-blue-400 transition"
            href="https://www.sdbkidsgame.xyz/"
            target="_blank"
            rel="noreferrer"
          >
            Live Site
